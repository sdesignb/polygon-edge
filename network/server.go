...
func NewServer(logger hclog.Logger, config *Config) (*Server, error) {
	...
	ps, err := pubsub.NewGossipSub(context.Background(), host, pubsub.WithPeerOutboundQueueSize(512), pubsub.WithValidateQueueSize(512), pubsub.WithMaxMessageSize(10<<20))
	if err != nil {
		return nil, err
	}
